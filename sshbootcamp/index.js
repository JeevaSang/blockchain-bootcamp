...
// Dict
let person = {"name": "kathir", "country": "India", "age": 33};
console.log("\nDict: ", person);
...
let txn1 = new Transaction("kathir", "deva", 10);

console.log("\n" + txn1.toString());

let txn2 = new Transaction("deva", "jai", 20);
...
let txn3 = new Transaction("jai", "kavi", 30);
...
txn1 = new Transaction("ram", "Joe", 50);
